...
def process_genes_intergenics_seq(contig, features_list, contig_seq, org, register_features: bool = False):
    ...
    :param register_features: boolean to fill_parents
    """
    # skip empty features_list with no features
    if not features_list:
        logging.getLogger("PPanGGOLiN").warning(
                f"Contig '{contig.name}' has no features. Skipping to the next contig.")
        return
...
""" The Functions below are used for debugging """
